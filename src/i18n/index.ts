...
const messages = {
  en: {
    ...
    experience: '4+ YRS',
    location: 'MOSCOW',
    heroPitch: 'I architect systems from database to UI and ship them to production. Solo architect of a no-code automation platform on Nuxt 4. Delivered a Vue 2→3 migration on a project that served millions of users without downtime.',
    heroCurrent: 'Enterprise no-code automation platform · Nuxt 4 · BPMN orchestration',
    heroStats: { years: 'YEARS', projects: 'PROJECTS', teams: 'PRODUCTION TEAMS', shipped: 'SHIPPED FROM SCRATCH' },
    heroLabels: {
      currentlyShipping: 'CURRENTLY SHIPPING',
      status: 'STATUS',
      availableForHire: 'AVAILABLE FOR HIRE',
      work: 'WORK',
      workVal: 'PROJECT / CONTRACT / FULLTIME',
      focus: 'FOCUS',
      focusVal: 'FRONTEND-FIRST FULLSTACK',
      lang: 'LANG',
      langVal: 'RU — NATIVE / EN — B2',
      links: 'LINKS',
      activity: 'ACTIVITY · 12W',
      commits: 'COMMITS',
    },
    metaBars: {
      about: { num: '— 01', name: 'ABOUT', right: 'EST. 2021', sep: '/', accent: 'RU + EN' },
      highlights: { num: '— 02', right: '9 ITEMS', sep: '/', accent: 'GRID' },
      services: { num: '— 03', right: '5 OFFERINGS', sep: '/', accent: 'FREELANCE' },
      projects: { num: '— 04', right: '3 SHIPPED', sep: '/', accent: 'REAL CLIENTS' },
      demos: { num: '— 05', right: '4 LIVE', sep: '/', accent: 'CONCEPTS' },
      experience: { num: '— 06', right: '2021', sep: '→', accent: 'NOW' },
      stack: { num: '— 07', right: '4 GROUPS', sep: '/', accent: '35 TOOLS' },
      contact: { num: '— 08', right: '3 CHANNELS', sep: '/', accent: 'REPLY < 24H' },
    },
    switchLang: 'RU',
    theme: {
      light: 'LIGHT',
    ...
    statement: 'I don\'t just write code — I architect systems from database to UI and ship them to production. Frontend-first fullstack with a track record of building platforms from zero and owning every technical decision.',
    highlights: {
      title: 'WHAT I DO',
      items: [
        'Domain-driven frontend architecture from scratch',
        'No-code platforms with BPMN orchestration',
        'Form & interface constructors, widget systems',
        'Production migrations: Vue 2→3, Nuxt 2→3→4',
        'Internal UI libraries (Radix, Reka, Shadcn)',
        'Engineering culture: CI, linting, conventional commits',
        'Storybook & VitePress documentation',
        'Product design & UI without a designer',
        'Mentoring juniors into mid-level engineers',
      ],
    },
    services: {
      title: 'SERVICES',
      items: [
        {
          name: '0→1 PRODUCT BUILD',
          desc: 'From idea to production-ready MVP. Architecture, frontend, backend, deploy.',
        },
        {
          name: 'LEGACY MIGRATION',
          desc: 'Vue 2→3, Nuxt 2→3→4, framework transitions without downtime.',
        },
        {
          name: 'ARCHITECTURE & SETUP',
          desc: 'Greenfield project foundation, monorepo, CI/CD, code quality standards.',
        },
        {
          name: 'INTERNAL TOOLS',
          desc: 'Admin panels, dashboards, no-code platforms, custom widget systems.',
        },
        {
          name: 'TECHNICAL CONSULTING',
          desc: 'Code review, architecture audit, team mentoring, tech decisions.',
        },
      ],
    },
    cta: {
      ...
      items: [
        {
          ...
          desc: 'Enterprise platform built from 0→1. BPMN process editor with custom renderers, visual form builder with schema versioning, full RBAC system.',
          stack: 'Nuxt 4 / TypeScript / BPMN.js / OAuth 2.0',
        },
        {
          name: 'E-COMMERCE PLATFORM MIGRATION',
          desc: 'Full Vue 2→3 migration on production with zero downtime. Micro-frontend architecture with isolated modules and dynamic registration.',
          stack: 'Vue 3 / Micro-frontends / Pinia / SCSS',
        },
        {
          name: 'INTERFACE CONSTRUCTOR',
          desc: 'Figma-level drag-and-drop interface builder for admin panels. Schema-driven rendering, custom widget system, live preview.',
          stack: 'Vue 3 / JSON Schema / Canvas API / TypeScript',
        },
      ],
    },
    jobs: {
    ...
    demos: {
      ...
      items: [
        ...
        {
          name: 'FORMA',
          niche: 'E-COMMERCE · PREMIUM AUDIO',
          desc: 'Premium product page for wireless headphones. Sticky scroll storytelling, color variant picker, real product photography, light luxury aesthetic.',
          stack: 'VUE 3 / TS / GSAP / SCSS',
          href: '/work/forma',
        },
      ],
    ...
    stack: {
      ...
      groups: [
        {
          label: 'CORE',
          items: ['TypeScript', 'JavaScript', 'Vue 3', 'Nuxt', 'Pinia', 'Tailwind', 'HTML/CSS', 'SCSS', 'SSR/SSG'],
        },
        {
          label: 'TOOLS',
          items: ['Vite', 'Vitest', 'Storybook', 'VitePress', 'ESLint', 'Prettier', 'npm / pnpm / yarn', 'Git', 'GitHub', 'GitLab', 'Docker', 'GitHub Actions', 'Notion'],
        },
        {
          label: 'BACKEND',
          items: ['Node.js', 'Python', 'FastAPI', 'PostgreSQL', 'Redis', 'REST API', 'Nginx', 'WebSocket'],
        },
        {
          label: 'DESIGN',
          items: ['Figma', 'Sketch', 'UI/UX', 'Responsive', 'Design Systems'],
        },
      ],
    },
    links: 'LINKS',
  ...
  ru: {
    ...
    experience: '4+ ГОДА',
    location: 'МОСКВА',
    heroPitch: 'Проектирую системы от базы данных до UI и довожу до прода. Единственный архитектор no-code платформы автоматизации на Nuxt 4. Провёл миграцию Vue 2→3 на проекте с миллионами пользователей — без даунтайма.',
    heroCurrent: 'Enterprise no-code платформа · Nuxt 4 · BPMN-оркестрация',
    heroStats: { years: 'ЛЕТ', projects: 'ПРОЕКТОВ', teams: 'PRODUCTION КОМАНД', shipped: 'SHIPPED С НУЛЯ' },
    heroLabels: {
      currentlyShipping: 'СЕЙЧАС ДЕЛАЮ',
      status: 'СТАТУС',
      availableForHire: 'ОТКРЫТ К РАБОТЕ',
      work: 'ФОРМАТ',
      workVal: 'ПРОЕКТ / КОНТРАКТ / FULLTIME',
      focus: 'ФОКУС',
      focusVal: 'FRONTEND-FIRST FULLSTACK',
      lang: 'ЯЗЫКИ',
      langVal: 'RU — РОДНОЙ / EN — B2',
      links: 'ССЫЛКИ',
      activity: 'АКТИВНОСТЬ · 12Н',
      commits: 'КОММИТОВ',
    },
    metaBars: {
      about: { num: '— 01', name: 'ОБО МНЕ', right: 'EST. 2021', sep: '/', accent: 'RU + EN' },
      highlights: { num: '— 02', right: '9 ПУНКТОВ', sep: '/', accent: 'ГРИД' },
      services: { num: '— 03', right: '5 УСЛУГ', sep: '/', accent: 'ФРИЛАНС' },
      projects: { num: '— 04', right: '3 SHIPPED', sep: '/', accent: 'РЕАЛЬНЫЕ КЛИЕНТЫ' },
      demos: { num: '— 05', right: '4 LIVE', sep: '/', accent: 'КОНЦЕПТЫ' },
      experience: { num: '— 06', right: '2021', sep: '→', accent: 'СЕЙЧАС' },
      stack: { num: '— 07', right: '4 ГРУППЫ', sep: '/', accent: '35 ИНСТРУМЕНТОВ' },
      contact: { num: '— 08', right: '3 КАНАЛА', sep: '/', accent: 'ОТВЕТ < 24Ч' },
    },
    switchLang: 'EN',
    theme: {
      light: 'СВЕТЛАЯ',
    ...
    statementTitle: 'ОБО МНЕ',
    statement: 'Я не просто пишу код — я проектирую системы от базы данных до UI и довожу до прода. Frontend-first фулстек с опытом создания платформ с нуля и полной ответственностью за технические решения.',
    highlights: {
      title: 'ЧТО Я ДЕЛАЮ',
      items: [
        'Доменные фронтенд-архитектуры с нуля',
        'No-code платформы с BPMN-оркестрацией',
        'Конструкторы форм, интерфейсов, виджетные системы',
        'Продакшн-миграции: Vue 2→3, Nuxt 2→3→4',
        'Внутренние UI-библиотеки (Radix, Reka, Shadcn)',
        'Инженерная культура: CI, линтинг, conventional commits',
        'Документация через Storybook и VitePress',
        'Продуктовый дизайн и UI без дизайнера',
        'Менторинг джуниоров до уровня мидлов',
      ],
    },
    services: {
      title: 'УСЛУГИ',
      items: [
        {
          name: 'ПРОДУКТ С НУЛЯ',
          desc: 'От идеи до production-ready MVP. Архитектура, фронтенд, бэкенд, деплой.',
        },
        {
          name: 'МИГРАЦИЯ LEGACY',
          desc: 'Vue 2→3, Nuxt 2→3→4, переход на новые фреймворки без даунтайма.',
        },
        {
          name: 'АРХИТЕКТУРА И SETUP',
          desc: 'Greenfield проекты, монорепо, CI/CD, стандарты качества кода.',
        },
        {
          name: 'ВНУТРЕННИЕ ИНСТРУМЕНТЫ',
          desc: 'Админ-панели, дашборды, no-code платформы, кастомные виджет-системы.',
        },
        {
          name: 'ТЕХНИЧЕСКИЙ КОНСАЛТИНГ',
          desc: 'Ревью кода, аудит архитектуры, менторинг команды, технические решения.',
        },
      ],
    },
    cta: {
    ...
    projects: {
      ...
      items: [
        {
          name: 'NO-CODE ПЛАТФОРМА АВТОМАТИЗАЦИИ',
          desc: 'Enterprise-платформа с нуля (0→1). BPMN-редактор процессов с кастомными рендерерами, визуальный конструктор форм с версионированием схем, полная система RBAC.',
          stack: 'Nuxt 4 / TypeScript / BPMN.js / OAuth 2.0',
        },
        {
          name: 'МИГРАЦИЯ E-COMMERCE ПЛАТФОРМЫ',
          desc: 'Полная миграция Vue 2→3 на продакшне без даунтайма. Микрофронтенд-архитектура с изолированными модулями и динамической регистрацией.',
          stack: 'Vue 3 / Micro-frontends / Pinia / SCSS',
        },
        {
          name: 'КОНСТРУКТОР ИНТЕРФЕЙСОВ',
          desc: 'Drag-and-drop конструктор интерфейсов уровня Figma для админ-панелей. Schema-driven рендеринг, кастомные виджеты, live preview.',
          stack: 'Vue 3 / JSON Schema / Canvas API / TypeScript',
        },
      ],
    },
    ...
    demos: {
      title: 'DEMO BUILDS',
      disclaimer: 'КОНЦЕПТЫ ДЛЯ ВЫМЫШЛЕННЫХ БРЕНДОВ · НЕ РЕАЛЬНЫЕ КЛИЕНТЫ',
      view: 'СМОТРЕТЬ',
      items: [
        {
          name: 'NORTHWIND',
        ...
        {
          name: 'FORMA',
          niche: 'E-COMMERCE · ПРЕМИУМ АУДИО',
          desc: 'Премиальная продуктовая страница для беспроводных наушников. Sticky scroll сторителлинг, выбор цвета, реальные продуктовые фото, light luxury эстетика.',
          stack: 'VUE 3 / TS / GSAP / SCSS',
          href: '/work/forma',
        },
      ],
