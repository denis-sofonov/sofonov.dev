...
const messages = {
  en: {
    ...
    process: {
      label: 'HOW I BUILD',
      title: 'PROCESS',
      subtitle: 'Five steps from first call to live product. Clear, predictable, no hidden add-ons.',
      stages: [
        {
          name: 'BRIEF',
          desc: 'We talk. Goals, users, constraints, budget. A 30-minute call, no preparation needed — I listen more than I pitch.',
          eta: '1 day',
          out: 'Aligned brief',
        },
        {
          name: 'SCOPE',
          desc: 'I break the work into milestones. Clear estimate, fixed price when possible, hourly when it\'s truly unknown. No hidden add-ons.',
          eta: '2-3 days',
          out: 'Proposal + timeline',
        },
        {
          name: 'PROTOTYPE',
          desc: 'Wireframes and interactive mockups in Figma. We agree on structure, flows, key screens — before any code is written.',
          eta: '1-2 weeks',
          out: 'Clickable prototype',
        },
        {
          name: 'BUILD',
          desc: 'Iterative development. Dev environment you can access anytime. Weekly demos. Easy to change while it\'s still clay.',
          eta: '4-12 weeks',
          out: 'Working product',
        },
        {
          name: 'LAUNCH',
          desc: 'Deploy to your infrastructure. Documentation. Handover call. Two weeks of warranty support on any bug that surfaces.',
          eta: '1 week',
    ...
    experience: '4+ YRS',
    location: 'MOSCOW',
    heroPitch: 'I design and build web applications end-to-end — from idea to production. Frontend, backend, architecture, deploy. One engineer, full ownership.',
    ...
    statement: 'From landing pages to complex platforms — I handle the full cycle. Clean architecture, polished UI, reliable backend. You get one person who understands the whole picture.',
    whatIBuild: {
      title: 'WHAT I BUILD',
      items: [
        {
    ...
    cta: {
      title: 'LET\'S WORK',
      subtitle: 'Need a web app, a platform, or a frontend that works? I\'m available for projects, contracts, and full-time.',
    },
    projects: {
      title: 'PROJECTS',
      items: [
    ...
    demos: {
      ...
      view: 'VIEW LIVE',
      note: 'Three sample builds shown here — more available on request.',
      items: [
        {
          name: 'NORTHWIND',
    ...
    stack: {
      title: 'STACK',
      subtitle: 'Tools I use day-to-day. Four years, forty-plus packages, no surprises.',
      groups: [
        {
          label: 'FRONTEND',
          items: ['JavaScript', 'TypeScript', 'Vue', 'Nuxt', 'Pinia', 'SCSS', 'Tailwind', 'Vite'],
        },
        {
          label: 'BACKEND',
          items: ['Node.js', 'Python', 'FastAPI', 'PostgreSQL', 'Redis', 'Nginx', 'WebSocket', 'REST API'],
        },
        {
          label: 'TOOLS',
          items: ['Git', 'Docker', 'Figma', 'Vitest', 'ESLint', 'CI/CD', 'Storybook', 'AI/LLM'],
        },
      ],
    },
    links: 'LINKS',
  ...
  ru: {
    ...
    process: {
      label: 'КАК Я РАБОТАЮ',
      title: 'ПРОЦЕСС',
      subtitle: 'Пять шагов от первого созвона до живого продукта. Предсказуемо, прозрачно, без скрытых пунктов.',
      stages: [
        {
          name: 'БРИФ',
          desc: 'Созвон. Цели, пользователи, ограничения, бюджет. 30 минут, готовиться не нужно — я слушаю больше, чем продаю.',
          eta: '1 день',
          out: 'Согласованный бриф',
        },
        {
          name: 'ОЦЕНКА',
          desc: 'Разбиваю работу на вехи. Чёткая оценка: фикс когда возможно, почасовка когда реально неизвестно. Без скрытых пунктов.',
          eta: '2-3 дня',
          out: 'Коммерческое предложение',
        },
        {
          name: 'ПРОТОТИП',
          desc: 'Wireframes и интерактивные макеты в Figma. Договариваемся о структуре, потоках, ключевых экранах — до того как появится код.',
          eta: '1-2 недели',
          out: 'Кликабельный прототип',
        },
        {
          name: 'СБОРКА',
          desc: 'Итеративная разработка. Dev-окружение с доступом в любой момент. Еженедельные демо. Легко менять, пока ещё глина.',
          eta: '4-12 недель',
          out: 'Работающий продукт',
        },
        {
          name: 'РЕЛИЗ',
          desc: 'Деплой на вашу инфраструктуру. Документация. Созвон-передача. Две недели гарантии на любой баг, который всплывёт.',
          eta: '1 неделя',
    ...
    experience: '4+ ГОДА',
    location: 'МОСКВА',
    heroPitch: 'Проектирую и разрабатываю веб-приложения от идеи до продакшна. Фронтенд, бэкенд, архитектура, деплой. Один инженер — полная ответственность.',
    ...
    statement: 'От лендингов до сложных платформ — я закрываю полный цикл. Чистая архитектура, отполированный UI, надёжный бэкенд. Один человек, который понимает всю картину.',
    whatIBuild: {
      title: 'ЧТО Я ДЕЛАЮ',
      items: [
        {
    ...
    cta: {
      ...
      subtitle: 'Нужно веб-приложение, платформа или фронтенд который работает? Открыт к проектам, контрактам и fulltime.',
    },
    projects: {
      title: 'ПРОЕКТЫ',
      items: [
    ...
    stack: {
      title: 'СТЕК',
      subtitle: 'Инструменты, которыми пользуюсь каждый день. Четыре года, 40+ пакетов, без сюрпризов.',
      groups: [
        {
          label: 'FRONTEND',
          items: ['JavaScript', 'TypeScript', 'Vue', 'Nuxt', 'Pinia', 'SCSS', 'Tailwind', 'Vite'],
